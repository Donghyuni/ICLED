...
// Servo adjustment
#define _DUTY_NEU 1687  // Servo angle: 0 degree
...
#define _SERVO_SPEED 220 // servo speed limit (unit: degree/second)
...
void loop()
{
  ...
  if(event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(50, 0.5));            //n값
...
{
  return (657 + (-2.27*(a_value)) + 1.97*0.001*(a_value)*(a_value)); // Replace this with the equation obtained from nonlinear regression analysis
}
