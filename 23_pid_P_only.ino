...
#define _DUTY_MIN 400   // Servo angle: E degree
...
{
  return (435 + (-1.25*(a_value)) + 9.13*0.0001*(a_value)*(a_value)); // Replace this with the equation obtained from nonlinear regression analysis
}
